...
- [x] 2. Implement Site Selection Tool

  - [x] 2.1 Create site_selection_tool function
    - Implement tool that calls Bedrock with Gordon Ramsay prompt
    - Return score (0-100), is_rejected flag, and commentary
    - _Requirements: 2.1, 2.2, 2.3, 2.4_

- [x] 3. Implement Proposal Tool

  - [x] 3.1 Create proposal_tool function
...
- [x] 4. Implement Progress Tracker Tool

  - [x] 4.1 Create progress_tool function
    - Implement tool that estimates gum count with Gen-Z hype beast prompt
    - Calculate percentage toward 1 million pieces
    - _Requirements: 4.1, 4.2, 4.3_

- [x] 5. Implement GumWall Agent with AgentCore wrapper

  - [x] 5.1 Create main agent with BedrockAgentCoreApp wrapper
  ...
  - [x] 5.2 Configure MCPClient for external MCP server integration
    - Set up MCPClient with managed integration pattern
    - Add MCP tools to agent alongside local tools
    - _Requirements: 7.1, 7.2, 7.3_
  - [x] 5.3 Create system prompt for agent orchestration
...
- [x] 6. Local testing
  ...
  - [x] 6.1 Test agent locally with agentcore CLI
